            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  10.heightBox,
                  "\$30000".text.color(redColor).fontFamily(bold).size(18).make(),
                  10.heightBox,
                  Row(
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: Icon(Icons.message_outlined,color: darkFontGrey,),
                      )
                    ],
                  ).box.padding(EdgeInsets.symmetric(horizontal: 16)).color(textfieldGrey).height(70).make(),
                20.heightBox,
                  Column(
                    children: [
                      Row(
                        children: [
                          ...
                          Row(
                            children: List.generate(3, (index) => VxBox().size(40, 40).margin(EdgeInsets.symmetric(horizontal: 4)).roundedFull.color(Vx.randomPrimaryColor).make()),
                          )
                  ...
                  20.heightBox,
                  productLike.text.fontFamily(bold).color(darkFontGrey).size(16).make(),
                  10.heightBox,
